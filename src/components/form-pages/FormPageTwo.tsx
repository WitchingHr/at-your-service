      ...
      <div className="mt-5 lg:mt-0 md:w-2/3">
        ...
        >
          ...
          <div className="flex justify-around gap-6">
            <button
              onClick={handleBack}
              className="w-32 px-5 py-2 mt-2 font-medium text-white bg-indigo-600 rounded-full md:ml-auto md:mt-4 md:mb-8 text-md"
            >
              Back
            </button>
            <button className="w-32 px-5 py-2 mt-2 font-medium text-white bg-indigo-600 rounded-full md:mt-4 md:mb-8 text-md">
              Continue
            </button>
          </div>
        </form>

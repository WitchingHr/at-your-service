	...
	return (
      ...
      <div id="book" className="section-container">
        <div className="flex items-center justify-between pt-8">
          <h2 className="text-3xl font-medium">Book an Estimate</h2>
        ...
        <div className="flex justify-between">
          ...
          <div className="w-2/3">
            ...
            >
              ...
              <button className="w-32 px-5 py-2 mt-4 mb-8 ml-auto font-medium text-white bg-indigo-400 rounded-full text-md">
                Continue
              </button>
            </form>
          </div>
